...
class ModernDashboard(QMainWindow):
    ...
    def create_heatmap_page(self):
        ...
        filter_button.clicked.connect(self.toggle_inpage_sidebar)
        ...
        close_button.clicked.connect(self.toggle_inpage_sidebar)
        ...
        self.filter_sidebar_inpage = sidebar
